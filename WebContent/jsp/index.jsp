...
<body>
		...
		<div id="bloccommerce">
		<div id="sousbloc1">
		<input type="radio" class="jj" name="commerce" value="achats" checked> Achats
		...
		<div id="vide">
  			<input type="checkbox" id="enchcours" name="enchcours">
  			<label for="enchcours">Enchères en cours</label>
		</div>
		<div id="vide">
 			<input type="checkbox" id="enchremportes" name="enchremportes"checked>
  			<label for="enchremportes">Enchères remportées</label>
  			</div>
		</div>
		<div id="sousbloc2">
		<input type="radio" class="jj" name="commerce" value="ventes" checked>Mes ventes
		...
		<div id="bloccommerce">
			...
			<div id="sousbloc2">
				<img src="https://dummyimage.com/200X200/000/fff" alt="image du produit" class="imageflottante">
