				...
				<div id="bloccommerce2">
							<div id="sousbloc3">
								<label for="pseudo">Pseudo</label>
									<input type="text" name="pseudo" class="pseudo" value="${requestScope.monprofil.pseudo}"/><br/>
								<label for="prenom">Prénom</label>
									<input type="text" name="prenom" class="prenom" value="${requestScope.monprofil.prenom}"><br/>
								...
								<label for="newmdp">Nouveau mot de passe</label>
									<input type="password" name="newmdp" class="newmdp"/><br/>
							</div>
							<!-- fin du sousbloc3 -->
							<div id="sousbloc3">
