				...
				<div id="bloccommerce2">
							<div id="sousbloc3">
								...
								<label for="telephone">Téléphone</label><input type="text"
									...
									name="codepostal" class="codeposte"
									value="${requestScope.monprofil.codepostal}" /><br /> <label
									for="mdpnow">Mot de passe actuel</label><input type="password"
									name="mdpnow" class="mdpnow"
									value="${requestScope.monprofil.mdpnow}" /><br /> <label
									for="newmdp">Nouveau mot de passe</label><input type="password"
									name="newmdp" class="newmdp" /><br />
							</div>
							<!-- fin du sousbloc3 -->
							<div id="sousbloc3">
								<label for="nom">Nom</label><input type="text" id="nom"
									class="nom" value="${requestScope.monprofil.nom}" /><br /> <label
									for="email">Email</label><input type="text" id=""
									email" class="email" value="${requestScope.monprofil.email}" /><br />
								...
								<label for="confirmation">Confirmation</label><input
									type="password" id="confirmation" class="confirmation" /><br />
							</div>
							<!-- fin du sousbloc4 -->
